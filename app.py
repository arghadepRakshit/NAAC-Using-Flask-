...
def submit_form():
    ...
    command = f"python sample11_3.1.3.py {user_input_312} {year_range1_312} {year_range2_312} {year_range3_312} {year_range4_312} {year_range5_312} {lakhs1_312} {lakhs2_312} {lakhs3_312} {lakhs4_312} {lakhs5_312}"
    ...
    # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_321} {year_range1_321} {year_range2_321} {year_range3_321} {year_range4_321} {year_range5_321} {lakhs1_321} {lakhs2_321} {lakhs3_321} {lakhs4_321} {lakhs5_321}"
    ...
    # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_322} {year_range1_322} {year_range2_322} {year_range3_322} {year_range4_322} {year_range5_322} {lakhs1_322} {lakhs2_322} {lakhs3_322} {lakhs4_322} {lakhs5_322}"
    ...
    # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_324} {year_range1_324} {year_range2_324} {year_range3_324} {year_range4_324} {year_range5_324} {lakhs1_324} {lakhs2_324} {lakhs3_324} {lakhs4_324} {lakhs5_324}"
    output_324 = subprocess.check_output(command, shell=True, text=True)
    ...
    # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_332} {year_range1_332} {year_range2_332} {year_range3_332} {year_range4_332} {year_range5_332} {lakhs1_332} {lakhs2_332} {lakhs3_332} {lakhs4_332} {lakhs5_332}"
    ...
    lakhs5_343 = request.form['343number5']
     ...
     # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_343} {year_range1_343} {year_range2_343} {year_range3_343} {year_range4_343} {year_range5_343} {lakhs1_343} {lakhs2_343} {lakhs3_343} {lakhs4_343} {lakhs5_343}"
    ...
    lakhs5_344 = request.form['344number5']
     ...
     # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_344} {year_range1_344} {year_range2_344} {year_range3_344} {year_range4_344} {year_range5_344} {lakhs1_344} {lakhs2_344} {lakhs3_344} {lakhs4_344} {lakhs5_344}"
    ...
    lakhs5_351 = request.form['351number5']
     ...
     # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_351} {year_range1_351} {year_range2_351} {year_range3_351} {year_range4_351} {year_range5_351} {lakhs1_351} {lakhs2_351} {lakhs3_351} {lakhs4_351} {lakhs5_351}"
    ...
    lakhs5_352 = request.form['352number5']
     ...
     # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_352} {year_range1_352} {year_range2_352} {year_range3_352} {year_range4_352} {year_range5_352} {lakhs1_352} {lakhs2_352} {lakhs3_352} {lakhs4_352} {lakhs5_352}"
    ...
    lakhs5_362 = request.form['362number5']
     ...
     # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_362} {year_range1_362} {year_range2_362} {year_range3_362} {year_range4_362} {year_range5_362} {lakhs1_362} {lakhs2_362} {lakhs3_362} {lakhs4_362} {lakhs5_362}"
    ...
    lakhs5_363 = request.form['363number5']
     ...
     # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_363} {year_range1_363} {year_range2_363} {year_range3_363} {year_range4_363} {year_range5_363} {lakhs1_363} {lakhs2_363} {lakhs3_363} {lakhs4_363} {lakhs5_363}"
    ...
    lakhs5_364 = request.form['364number5']
     ...
     # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_364} {year_range1_364} {year_range2_364} {year_range3_364} {year_range4_364} {year_range5_364} {lakhs1_364} {lakhs2_364} {lakhs3_364} {lakhs4_364} {lakhs5_364}"
    ...
    lakhs5_371 = request.form['371number5']
     ...
     # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_371} {year_range1_371} {year_range2_371} {year_range3_371} {year_range4_371} {year_range5_371} {lakhs1_371} {lakhs2_371} {lakhs3_371} {lakhs4_371} {lakhs5_371}"
    ...
    lakhs5_372 = request.form['372number5']
     ...
     # Execute the Python script with form data
    command = f"python sample11_3.1.3.py {user_input_372} {year_range1_372} {year_range2_372} {year_range3_372} {year_range4_372} {year_range5_372} {lakhs1_372} {lakhs2_372} {lakhs3_372} {lakhs4_372} {lakhs5_372}"
