...
def is_it_doc(shareable_link):
       ...
       doc_path = 'C:\\Users\\HP\\Desktop\\New folder (2)\\download.doc'
       if doc_ok(doc_path):
           return True
       else:
           return False
...
if __name__ == "__main__":
    ...
    directory_path = r'C:\Users\HP\Desktop\New folder (2)\Downloaded_EXCEL'
    new_excel_name = 'sss.xlsx'
    rename_excel_in_directory(directory_path, new_excel_name)

    excel_path = r'C:\Users\HP\Desktop\New folder (2)\Downloaded_EXCEL\sss.xlsx'
    ...
    for index, shareable_link in df.iloc[1:, df.columns.get_loc(link_column)].items():
        ...
        pdf_path = 'C:\\Users\\HP\\Desktop\\New folder (2)\\Download_pdf\\'
        if not os.listdir(destination_folder):
            continue
        pdf_dwn = pdf_download(destination_folder)[0]
        img_path = 'C:\\Users\\HP\\Desktop\\New folder (2)\\Download_img\\'  
        ...
        if is_pdf_corrupted(pdf_dwn):
            if is_img_corrupted(img_dwn) :
               if is_it_doc(shareable_link):
                 doc_file_path = r'C:\Users\HP\Desktop\New folder (2)\downloaded_file.doc'
